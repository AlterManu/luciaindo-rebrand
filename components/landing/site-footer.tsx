      ...
      <div className="mx-auto max-w-7xl px-6 py-14 md:px-10">
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          <div className="flex flex-col leading-none">
            <span className="font-serif text-2xl tracking-tight text-foreground">
              Lucía Indo<span className="italic">.</span>
            </span>
        ...
        <div className="mt-10 flex flex-col gap-4 border-t border-border pt-8 md:flex-row md:items-center md:justify-between">
          <p className="max-w-xl text-pretty text-xs leading-relaxed text-muted-foreground">
            Este espacio no sustituye una atención de urgencia. Si estás atravesando una crisis o
            pensás que podés hacerte daño, comunicate con los servicios de emergencia de tu país.
          </p>
