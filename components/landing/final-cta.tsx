      ...
      <div className="mx-auto grid max-w-6xl gap-12 px-5 py-20 md:grid-cols-2 md:gap-16 md:px-8 md:py-28">
        <div>
          ...
          <p className="mt-6 max-w-md text-pretty leading-relaxed text-secondary-foreground/85">
            Si estás considerando comenzar terapia, podés completar una consulta breve para conocer
            la disponibilidad actual y coordinar una primera sesión. Te respondo personalmente.
          </p>
          ...
          {sent ? (
            <div className="flex h-full min-h-64 flex-col items-center justify-center text-center">
              ...
              <p className="mt-3 max-w-sm text-pretty leading-relaxed text-muted-foreground">
                Recibí tu consulta y te responderé con la disponibilidad actual y los próximos
                pasos para coordinar una primera sesión.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <p className="text-center text-xs leading-relaxed text-muted-foreground">
                El valor y las condiciones se informan al responder tu consulta, antes de confirmar
                la primera sesión.
              </p>
            </form>
          )}
