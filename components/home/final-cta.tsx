    ...
    <section id="consultar" className="relative">
      ...
      <div className="text-center mx-auto grid md:max-w-2xl lg:max-w-4xl xl:max-w-7xl gap-12 px-8 py-20 md:gap-16 md:px-8 md:py-28">
        <div className="xl:w-3/4 mx-auto text-secondary-foreground">
          <span className="lg:text-left font-medium uppercase tracking-[0.24em] text-secondary-foreground/60 text-[0.72rem] xl:text-base">
            Reservar consulta
          </span>
          ...
          <p className="xl:text-lg mt-6 sm:px-16 text-pretty leading-relaxed text-secondary-foreground/85">
          ...
          <Link
            ...
            className="text-base lg:text-xl mt-10 w-fit font-serif bg-primary text-secondary hover:bg-accent transition-all duration-400 rounded-xl px-6 py-2 inline-flex items-center gap-1.5"
          >
