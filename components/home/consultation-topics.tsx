  ...
  return (
    <section id="motivos">
      <div className="bg-secondary flex justify-center">
        <div className="w-full grid justify-center items-center xl:grid-cols-[0.75fr_1.25fr] xl:max-w-7xl">
          {/* Image column */}
          <div className="relative w-screen h-[60vh] lg:h-[75vh] xl:h-3/4 xl:w-auto overflow-hidden xl:rounded-2xl">
            <Image
              src="/images/work.jpg"
          ...
          <div className="mx-auto flex flex-col justify-center max-w-2xl lg:max-w-4xl xl:max-w-7xl px-6 py-16 text-secondary-foreground lg:px-12 lg:py-20">
            ...
            <ul className="mt-6 grid gap-x-8 gap-y-6 lg:gap-x-4 lg:gap-y-4 sm:grid-cols-2">
              {topics.map((topic, i) => (
                <li
                  key={i}
                ...
                >
                  <img
                    ...
                    alt="hojas"
                  />
                  <span className="text-sm md:text-base text-pretty leading-relaxed text-secondary">
                    {topic}
                  </span>
                </li>
              ))}
            ...
            <p className="mt-9 text-sm md:text-base lg:text-lg text-pretty leading-relaxed text-secondary-foreground/70 italic">
